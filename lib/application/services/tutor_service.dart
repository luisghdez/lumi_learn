...
class TutorService {
  ...
  /// Sends an image message to an existing thread using streaming response
  Stream<Map<String, dynamic>> sendImageToThreadStream({
    required String token,
    required String threadId,
    required String imagePath,
  }) {
    final uri = Uri.parse('$_baseUrl/threads/$threadId/messages/image');
    final client = http.Client();
